...
$('#modal-form').on('submit', function (e) {
    ...
    if ($("#defaultForm-id").val() !== "") {
        ...
        $.ajax({
            url : 'https://167.99.53.134:8080/api/firestore/update/Assignments/'+$("#defaultForm-id").val(),
            type: "POST",
...
$('#confirmation-form').on('submit', function (e) {
    e.preventDefault();
    $.ajax({
        url : 'https://167.99.53.134:8080/api/firestore/delete/Assignments/'+$("#confirmForm-assignment").val(),
        type: "POST",
        data: {
